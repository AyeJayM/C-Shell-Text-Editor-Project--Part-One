...
@author Austin Martinez (CS 2600 FINAL) / Stephen Brennan

@data   November 29th, 2021
...
/**
 ...
 @param args Null terminated list of arguements (including program).
